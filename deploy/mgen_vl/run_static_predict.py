...
from paddlemix import MGenVLProcessor, MGenVLTokenizer
...
class Predictor(object):
    def __init__(self, args):
        ...
        self.tokenizer = MGenVLTokenizer.from_pretrained(args.model_name_or_path)
        self.processor = MGenVLProcessor(tokenizer=self.tokenizer)
    ...
    def generate_with_image_features(self, image_features, input_ids):
        ...
        [tokens] = self.second_predictor.run(inputs)
